...
$app_setting = new AppSetting();
    ...
    $display_ads = [
        [
            'key' => 'banner_ad_game_list',
            'label' => 'Banner Ad on All Game List'
        ],
        [
        ...
        [
            'key' => 'banner_ad_game_detail',
            'label' => 'Banner Ad on All Game Detail'
        ],
        [
            'key' => 'banner_ad_game_search',
            'label' => 'Banner Ad on All Game Search'
        ],
        [
            'key' => 'interstitial_ad_game_list',
            'label' => 'Interstitial Ad on All Game List'
        ],
        [
        ...
        [
            'key' => 'interstitial_ad_game_detail',
            'label' => 'Interstitial Ad on All Game Detail'
        ]
    ];
                        ...
                        <form method="post" action="">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h4 class="mb-3">yodo1</h4>
                                    <hr>
                                    <div class="form-group">
                                        <label for="yodo1_banner_id" class="form-label">yodo1 Banner Placement ID-Android </label>
                                        <input name="value[Admob_ad_id]" id="Admob_ad_id" type="text" class="form-control" value="<?= isset($value) && isset($value->Admob_ad_id)  ? $value->Admob_ad_id : '' ?>" placeholder="Enter Your Admob ad ID">
                                    </div>
                                    <div class="form-group">
                                        <label for="yodo1_interstitial_id" class="form-label">yodo1 Interstitial Placement ID-Android </label>
                                        <input name="value[yodo1_interstitial_id]" id="yodo1_interstitial_id" type="text" class="form-control" value="<?= isset($value) && isset($value->yodo1_interstitial_id)  ? $value->yodo1_interstitial_id : '' ?>" placeholder="Enter Your Admob ad ID">
                                    </div>
                                    <div class="form-group">
                                        <label for="yodo1_banner_id_ios" class="form-label">yodo1 Banner Placement ID-iOS </label>
                                        <input name="value[yodo1_banner_id_ios]" id="yodo1_banner_id_ios" type="text" class="form-control" value="<?= isset($value) && isset($value->yodo1_banner_id_ios)  ? $value->yodo1_banner_id_ios : '' ?>" placeholder="Enter Your Admob ad ID">
                                    </div>
                                    <div class="form-group">
                                        <label for="yodo1_interstitial_id_ios" class="form-label">yodo1 Interstitial Placement ID-iOS </label>
                                        <input name="value[yodo1_interstitial_id_ios]" id="yodo1_interstitial_id_ios" type="text" class="form-control" value="<?= isset($value) && isset($value->yodo1_interstitial_id_ios)  ? $value->yodo1_interstitial_id_ios : '' ?>" placeholder="Enter Your Admob ad ID">
                                    </div>
