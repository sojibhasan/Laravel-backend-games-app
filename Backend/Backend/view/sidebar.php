    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="mm-sidebar-menu">
            <ul id="mm-sidebar-toggle" class="side-menu">
                ...
                <li class="<?= $active === 'game' ? 'active' : '' ?>">
                    <a href="#game" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon" id="mm-game-1" viewBox="0 0 24 24"
                                stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <ul id="game" class="submenu collapse" data-parent="#mm-sidebar-toggle">
                        <li class="<?= $active_submenu === 'game_list' ? 'active' : '' ?>">
                            <a href="../view/index.php?page=game" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="mm-game-list" class="svg-icon" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        <rect x="5" y="3" width="14" height="18" rx="2" />
                                        <line x1="9" y1="7" x2="15" y2="7" />
                        ...
                        <li class="<?= $active_submenu === 'game_create' ? 'active' : '' ?>">
                            <a href="../view/index.php?page=game_create" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg"  id="mm-game-add" class="svg-icon" viewBox="0 0 24 24" stroke-width="2"
                                        stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <rect x="4" y="4" width="16" height="16" rx="2" />
                                            <line x1="9" y1="12" x2="15" y2="12" />
